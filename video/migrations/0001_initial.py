...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('video_video', (
            ...
            ('page_title', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ...
            ('file_suffix', self.gf('django.db.models.fields.CharField')(max_length=10)),
    ...
    models = {
        ...
        'video.video': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page_title': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'page_url': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['video.Profile']"}),
